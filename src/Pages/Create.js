...
function Create() {
  ...
  useEffect(() => {
    ...
    if (request.amount != 0) {
      var formattedPrice = Number.parseFloat(
  ...
  async function getTransactionSignatureMessage() {
    const message = await requestTransactionSignatureMessage (
      address,
      EvmChain.ETHEREUM,
      "evm"
    );
    ...
    <div class=" w3-animate-opacity">
      <div class="container page create no-relative ">
        {!isShare && isPageLoading ? (
          <>
            <a>{true ? "Sign transaction" : "Authenticate"}</a>{" "}
            <h1 id="share-title">
              {true ? "Waiting on signature" : "Creating request"}
            </h1>
          </>
        ) : (
          <>
        ...
        {isPageLoading ? (
          <div
            class={
              isMobile
                ? "loading-transactions w3-animate-bottom"
          ...
          >
            ...
            {showCancel? 
          <button onClick={()=> refresh()} class="btn btn-primary btn-restart w3-animate-bottom">Page stuck? Refresh here</button>  :<></>}
  ...
  <div class="row ">
    ...
    <div class="create-content">
      <div class="list-group mb-3">
        ...
        <Tokens 
          ...
          tokenSelect={setSelectedToken}
          togglestate={closeTokenPopUp}
          />
        ) : (
        <div class="tokens-list-item selected">
          <img src={request.token.icon} width="34" />{" "}
          <b>{request.token.symbol}</b> - {request.token.name}{" "}
          <span
            onClick={() => setIsTokenPopUp(true)}
          class="change-token-link"
          >
          Select
          </span>
        </div>
      ...
      <div class="form-create">
        ...
        <div class="input-group mb-3">
          ...
          <input id={isAmountInvalid?"invalid-amount":""}
            type="text"
            placeholder="0.125"
            onChange={(e) =>
          setRequest((request) => ({
        ...
        <div class="input-group bottom-mobile">
          ...
          class="btn btn-primary btn-lg btn-generate btn-sign"
          >
          <span>Sign</span>
    ...
    <div class="create-mobile-bottom w3-animate-bottom">
      <button
        type="button"
        onClick={() => storeRequest()}
      class="btn btn-primary btn-lg btn-sign"
      >
      <span>Sign</span>
      <img src={Sign} width="20" />
      </button>
      ...
      <div class="display-flex social">
        ...
        <div class="mb-3 mobile-share-container">
          ...
          <div onClick={() =>
            navigator.clipboard
            .writeText(plainText)
            .then(() => alert("Request copied."))
            } class="share-text">{plainText.toString()}
          </div>
        </div>
        :<></>}
        <div class="socials">
          ...
          <div>
            ...
            encodeURIComponent(cdiLink) +
            "&text=" +
            encodeURIComponent(shareText)
            }
            >
            <img src={Telegram} width="18" />{" "}
            <span>Telegram</span>
            </a>{" "}
          </div>
          <div>
            ...
            type="button"
            href={
            "https://www.facebook.com/sharer.php?u=" + cdiLink
            }
            >
          ...
          <div>
            {" "}
            <a
              href={"sms:{phone_number}?body=" + shareText}
              type="button"
              >
